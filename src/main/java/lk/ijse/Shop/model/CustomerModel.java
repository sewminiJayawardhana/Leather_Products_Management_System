...
public class CustomerModel {
    public List<CustomerDto> getAllCustomers() throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            String cus_email = resultSet.getString(2);

            var dto = new CustomerDto(cus_id, cus_name, cus_address, cus_email);
            dtoList.add(dto);
        }
        return dtoList;
    }
    ...
    public CustomerDto searchCustomer(String id) throws SQLException {
        ...
        if(resultSet.next()) {
            ...
            dto = new CustomerDto(cus_id, cus_name, cus_address, cus_email);
        }
